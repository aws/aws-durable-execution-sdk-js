 ...
 * the plugin's execution identity, its spans and its operation maps are
 * per-execution, and operation IDs are unique only within an execution, so one
 * instance cannot serve two concurrent executions.
 *
