...
const OperationFilterSensitiveLog = (obj) => ({
    ...
    ...(obj.ChainedInvokeDetails && {
        ChainedInvokeDetails: ChainedInvokeDetailsFilterSensitiveLog(obj.ChainedInvokeDetails),
    }),
});
...
const EventFilterSensitiveLog = (obj) => ({
    ...
    ...(obj.ChainedInvokePendingDetails && {
        ChainedInvokePendingDetails: ChainedInvokePendingDetailsFilterSensitiveLog(obj.ChainedInvokePendingDetails),
    }),
    ...(obj.ChainedInvokeSucceededDetails && {
        ChainedInvokeSucceededDetails: ChainedInvokeSucceededDetailsFilterSensitiveLog(obj.ChainedInvokeSucceededDetails),
    }),
    ...(obj.ChainedInvokeFailedDetails && {
        ChainedInvokeFailedDetails: ChainedInvokeFailedDetailsFilterSensitiveLog(obj.ChainedInvokeFailedDetails),
    }),
    ...(obj.ChainedInvokeTimedOutDetails && {
        ChainedInvokeTimedOutDetails: ChainedInvokeTimedOutDetailsFilterSensitiveLog(obj.ChainedInvokeTimedOutDetails),
    }),
    ...(obj.ChainedInvokeStoppedDetails && {
        ChainedInvokeStoppedDetails: ChainedInvokeStoppedDetailsFilterSensitiveLog(obj.ChainedInvokeStoppedDetails),
    }),
    ...
    ...(obj.InvocationCompletedDetails && {
        InvocationCompletedDetails: InvocationCompletedDetailsFilterSensitiveLog(obj.InvocationCompletedDetails),
    }),
});
...
const de_StopDurableExecutionCommand = async (output, context) => {
    ...
    const data = smithyClient.expectNonNull(smithyClient.expectObject(await core$1.parseJsonBody(output.body, context)), "body");
    const doc = smithyClient.take(data, {
        StopTimestamp: (_) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_))),
    });
    Object.assign(contents, doc);
    return contents;
};
...
const de_StepDetails = (output, context) => {
    return smithyClient.take(output, {
        ...
        Error: smithyClient._json,
        NextAttemptTimestamp: (_) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_))),
        Result: smithyClient.expectString,
    });
};
const de_WaitDetails = (output, context) => {
    return smithyClient.take(output, {
        ScheduledEndTimestamp: (_) => smithyClient.expectNonNull(smithyClient.parseEpochTimestamp(smithyClient.expectNumber(_))),
    });
};
...
exports.ChainedInvokeDetailsFilterSensitiveLog = ChainedInvokeDetailsFilterSensitiveLog;
exports.ChainedInvokeFailedDetailsFilterSensitiveLog = ChainedInvokeFailedDetailsFilterSensitiveLog;
exports.ChainedInvokePendingDetailsFilterSensitiveLog = ChainedInvokePendingDetailsFilterSensitiveLog;
exports.ChainedInvokeStoppedDetailsFilterSensitiveLog = ChainedInvokeStoppedDetailsFilterSensitiveLog;
exports.ChainedInvokeSucceededDetailsFilterSensitiveLog = ChainedInvokeSucceededDetailsFilterSensitiveLog;
exports.ChainedInvokeTimedOutDetailsFilterSensitiveLog = ChainedInvokeTimedOutDetailsFilterSensitiveLog;
...
exports.InvocationCompletedDetailsFilterSensitiveLog = InvocationCompletedDetailsFilterSensitiveLog;
