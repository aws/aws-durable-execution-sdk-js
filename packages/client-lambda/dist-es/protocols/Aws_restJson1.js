...
export const se_ListDurableExecutionsByFunctionCommand = async (input, context) => {
    const b = rb(input, context);
    const headers = {};
...
export const de_ListDurableExecutionsByFunctionCommand = async (output, context) => {
    if (output.statusCode !== 200 && output.statusCode >= 300) {
        return de_CommandError(output, context);
    }
    const contents = map({
...
const de_Event = (output, context) => {
    return take(output, {
        ...
        Id: __expectString,
        InvocationCompletedDetails: (_) => de_InvocationCompletedDetails(_, context),
        Name: __expectString,
