...
const AGENT_INSTRUCTION = [
  ...
  "  (e.g. describe the fields/structure you found, name the relevant columns,",
  "  summarize the numbers) — not just a bare table. Include `query` when a",
  "  result table supports the answer, plus explanation, suggestedCharts, and",
  "  rowLevel. This is a CONVERSATION: you may reference earlier turns, and if a",
  "  follow-up can be answered from what you already know without a new query,",
